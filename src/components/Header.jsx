...
function Header({ usuario, onLoginClick, onLogoutClick, onCarritoClick }) {
  ...
  return (
    <header className="sticky top-0 w-full z-40 bg-background/92 backdrop-blur-xl border-b border-surface-variant">
      <div className="max-w-360 mx-auto px-4 md:px-8 h-20 flex items-center justify-between gap-4">
        ...
        {/* NAV LINKS */}
        <nav className="hidden md:flex items-center gap-1 font-display font-semibold text-xs tracking-wide">
          <a href="#" className="px-4 py-2 rounded-lg text-primary bg-surface-container border border-primary/30 shadow-sm">
            CATÁLOGO
          </a>
          <a href="#" className="px-4 py-2 rounded-lg text-on-surface-variant hover:text-parchment-light hover:bg-surface-container transition-colors">
            MI CUENTA
          </a>
          <a href="#" className="px-4 py-2 rounded-lg text-on-surface-variant hover:text-parchment-light hover:bg-surface-container transition-colors">
            MIS PEDIDOS
        ...
        <div className="flex items-center gap-3">
          {usuario ? (
            <button 
              ...
              className="px-4 h-11 rounded-full bg-surface-container-high/80 border border-surface-variant flex items-center gap-2 text-on-surface-variant hover:text-primary hover:border-primary transition-all duration-200"
            >
            ...
            <button 
              ...
              className="px-5 h-11 rounded-full bg-surface-container-high/80 border border-surface-variant flex items-center justify-center text-on-surface-variant hover:text-primary hover:border-primary transition-all duration-200"
            >
